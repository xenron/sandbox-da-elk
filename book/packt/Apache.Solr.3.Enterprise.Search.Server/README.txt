Welcome to the Apache Solr 3 Enterprise Search book example code.  

All the examples are broken up by chapter number, i.e. /9 contains examples for Chapter 9: Integration.  The bundled /solr directory contains Solr 3.4 that has been tested with the sample code.
